      ...
      <div>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter your location and solar array details to get an estimate.</CardDescription>
          </CardHeader>
          <CardContent>
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="grid gap-4">
                <RadioGroup defaultValue="address" className="flex items-center gap-4">
                  <Label
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="capacity" type="number" min="1" placeholder="5" required />
                </div>
              </div>
              <div className="grid gap-4">
                <Card className="bg-card-foreground">
                  ...
                  <CardContent>
                    ...
                    <p className="text-muted-foreground">Based on your location and solar array capacity.</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader>
                  ...
                  <CardContent>
                    ...
                    <p className="text-muted-foreground">Compared to your current electricity costs.</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader>
                  ...
                  <CardContent>
                    ...
                    <p className="text-muted-foreground">Reduction in carbon emissions.</p>
                  </CardContent>
                </Card>
              </div>
            </form>
